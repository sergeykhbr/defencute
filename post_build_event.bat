...
xcopy %QT_PATH%\lib\Qt6StateMachined.lib %COPY_TO%\ /F /R /Y /D
xcopy %QT_PATH%\bin\Qt6StateMachined.dll %COPY_TO%\ /F /R /Y /D
...
xcopy %QT_PATH%\lib\Qt6StateMachine.lib %COPY_TO%\ /F /R /Y /D
xcopy %QT_PATH%\bin\Qt6StateMachine.dll %COPY_TO%\ /F /R /Y /D
