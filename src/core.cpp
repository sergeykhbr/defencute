...
void Core::configurate(QString filename) {
    ...
    "  'ActionButtons':{\n"
    "           'BuildBarricade':{\n"
    "                              'iconFile':':/images/user_actions.png',\n"
    "                              'iconx':0,\n"
    "                              'icony':0,\n"
    "                              'x':900,\n"
    "                              'y':704,\n"
    ...
    "                'Waves':[\n"
    "                          [\n"
    "                            {'Type':'EventUser', 'Value':'StartWave'},\n"
    "                            {'Type':'Group',\n"
    "                             'Name':'gr0',\n"
    "                             'Period':800,\n"
    "                             'Respawn':2,\n"
    "                             'Spawn':[\n"
    "                                       {'dt':5, 'Spawn':'Enemy', 'Route':'route1', 'offx':10, 'offy':5},\n"
    "                                       {'dt':65, 'Spawn':'Enemy', 'Route':'route1', 'offx':0, 'offy':-5},\n"
    "                                       {'dt':75, 'Spawn':'Enemy', 'Route':'route1', 'offx':0, 'offy':-15},\n"
    "                                       {'dt':600, 'Spawn':'Enemy', 'Route':'route1', 'offx':-10, 'offy':15}\n"
    "                                     ]\n"
    "                            },\n"
    "                            {'Type':'EventTimeout', 'Period':2000},\n"
    "                            {'Type':'Group',\n"
    "                             'Name':'gr1',\n"
    "                             'Period':1000,\n"
    "                             'Respawn':10,\n"
    "                             'Spawn':[\n"
    "                                       {'dt':5, 'Spawn':'Enemy', 'Route':'route1', 'offx':0, 'offy':5},\n"
    "                                       {'dt':5, 'Spawn':'Enemy', 'Route':'route1', 'offx':0, 'offy':-5},\n"
    "                                       {'dt':65, 'Spawn':'Enemy', 'Route':'route1', 'offx':0, 'offy':5},\n"
    "                                       {'dt':65, 'Spawn':'Enemy', 'Route':'route1', 'offx':0, 'offy':-5},\n"
    "                                       {'dt':125, 'Spawn':'Enemy', 'Route':'route1', 'offx':0, 'offy':5},\n"
    "                                       {'dt':125, 'Spawn':'Enemy', 'Route':'route1', 'offx':0, 'offy':-5},\n"
    "                                       {'dt':185, 'Spawn':'Enemy', 'Route':'route1', 'offx':0, 'offy':5},\n"
    "                                       {'dt':185, 'Spawn':'Enemy', 'Route':'route1', 'offx':0, 'offy':-5},\n"
    "                                       {'dt':245, 'Spawn':'Enemy', 'Route':'route1', 'offx':0, 'offy':5},\n"
    "                                       {'dt':245, 'Spawn':'Enemy', 'Route':'route1', 'offx':0, 'offy':-5}\n"
    "                                     ]\n"
    "                            },\n"
    "                            {'Type':'EventTimeout', 'Period':10000},\n"
    "                            {'Type':'EventWaveEnd'}\n"
    "                          ]\n"
    "                       ]\n"
    "             }\n"
